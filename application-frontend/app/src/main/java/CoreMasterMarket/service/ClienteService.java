...
public class ClienteService {
    ...
    private static final String API_URL = "http://localhost:8081/api/v1/clientes/list";
    private static final String ADD_API_URL = "http://localhost:8081/api/v1/clientes/add";
    private static final String UPDATE_API_URL = "http://localhost:8081/api/v1/clientes/update";
    private static final String DELETE_API_URL = "http://localhost:8081/api/v1/clientes/delete";
    ...
    public ClienteService(DefaultListModel<String> model) {
        this.model = model;
    }
