package com.rodolfobrandao.coremastermarket.entities.produto;
...
public class Produto implements Serializable {
    ...
    public Produto(BigDecimal precoVenda, String codigoBarras, String tipoEmbalagem, String descricao, BigDecimal quantidade, LocalDateTime criadoEm, LocalDateTime atualizadoEm, Marca marca, boolean ativo) {
    ...
    public Produto(BigDecimal precoVenda, String codigoBarras, String tipoEmbalagem, String descricao, BigDecimal quantidade, LocalDateTime criadoEm, Marca marca, boolean ativo) {
        this.precoVenda = precoVenda;
        this.codigoBarras = codigoBarras;
        this.tipoEmbalagem = tipoEmbalagem;
        this.descricao = descricao;
